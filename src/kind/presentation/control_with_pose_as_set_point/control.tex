\begin{frame}[allowframebreaks]{Control - General explanation}
    ...
    \section{Cost function}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.9\textwidth]{/home/donkarlo/Dropbox/repo/nd_research_publication/src/kind/presentation/control_with_pose_as_set_point/a_typical_controller.png}
        \end{figure}
