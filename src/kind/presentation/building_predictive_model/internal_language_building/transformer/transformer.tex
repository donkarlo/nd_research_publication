...
\begin{frame}[allowframebreaks]{Predictive brain - Transformers as predictors for Klaman filter}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{/home/donkarlo/Dropbox/repo/nd_research_publication/src/kind/presentation/building_predictive_model/internal_language_building/transformer/transformer.png}
    \end{figure}
...
\end{frame}
    \subsection{}
    \input{/home/donkarlo/Dropbox/repo/nd_research_publication/src/kind/presentation/building_predictive_model/internal_language_building/transformer/gaussian_transformer}
    \input{/home/donkarlo/Dropbox/repo/nd_research_publication/src/kind/presentation/building_predictive_model/internal_language_building/transformer/gaussian_transformer_loss_and_uncertainty_meaning}
