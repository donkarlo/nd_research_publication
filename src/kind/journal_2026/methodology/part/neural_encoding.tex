...
\begin{document}
    ...
    \section{Neural encoding}
        ...
        \subsection{Language}
            at word level the second derivitave is vowel and the 0th derivative is consum
            
            yat sentence level we will continually have verb->object, object here is a class derived from clustering phases. verb is equal to vowel in word level and Object is the consum
