   ...
   \section{These items must be learned from these sensory data}
      ...
      \begin{itemize}
         ...
         \begin{itemize}
            ...
            \item Refractory period (During which even if enough evidence exists for another spike, the neuron cant spike). We must pay attention to the factwith each spike the whole evidences are evacuated and the system returns back to its resting potenmtial
