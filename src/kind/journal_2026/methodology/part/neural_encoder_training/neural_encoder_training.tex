...
\begin{document}
      ...
      \begin{itemize}
         ...
         \begin{itemize}
            ...
            \begin{itemize}
               ...
               \item learning the resting membrane potential value (in some biological neurons.png it is -50). It is the average amount of evidences/potentials(IPSP, EPSP) that the state neuron has while the agent is not in that state. It will represent prior or base line evidence that usually exist in teh state neuron
   ...
   \section{Grand mother neurons.png that are used only in training phase}
