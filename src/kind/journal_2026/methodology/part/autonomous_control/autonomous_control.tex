...
\begin{document}
   ...
   \section{Data flow}
      \begin{figure}[H]
         \centering
         \includegraphics[width=0.9\textwidth]{dat_flow_schema.jpg}
      \end{figure}
   ...
   \seeherefooter{/nd_robotic_ai_learning_project/src/robot/part/mind/plan/plan.tex}
      ...
      In this research planning is from top to bottom, that is first  a group of sentences form the concept of turning around the perimeter of a corridor. 
        \begin{figure}[H]
           \centering
      ...
      In this research planning is based on breaking anomaly vector at each level to anomaly vectors in lower level. 
