...
\begin{document}
   ...
   \section{Modules}
      ...
      \subsection{nd\_math}
         ...
         includes
         \begin{itemize}
            \item Vector calculation
            \item Matrix calculation
            \item Descripecny distance
         \end{itemize}
      ...
      \subsection{nd\_datascience}
         ...
         includes
         \begin{itemize}
            \item Machine learning modules
            \begin{itemize}
               \item Gaussian transformer
               \item DBSN clustering
               \item classification (nearset neighbour)
            \end{itemize}
      ...
      \subsection{nd\_physics}
         ...
         \begin{figure}[H]
            \centering
            \includegraphics[width=0.9\textwidth]{phisycs.png}
         \end{figure}
